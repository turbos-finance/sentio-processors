...
export async function calculateTokenValue_USD(
    ...
    try {
        ...
        ctx.meter.Gauge("TVL_by_Token_USD").record(value_a, { pairName, pairFullName, name: name_a, symbol: poolInfo.symbol_a, type: poolInfo.type_a })
        ctx.meter.Gauge("TVL_by_Token_USD").record(value_b, { pairName, pairFullName, name: name_b, symbol: poolInfo.symbol_b, type: poolInfo.type_b })

        ctx.meter.Counter("TVL_by_Token_USD_Counter").add(value_b!, { pairName, pairFullName, name: name_b, symbol: poolInfo.symbol_b, type: poolInfo.type_a })
        ctx.meter.Counter("TVL_by_Token_USD_Counter").add(value_a!, { pairName, pairFullName, name: name_a, symbol: poolInfo.symbol_a, type: poolInfo.type_b })

        ctx.meter.Gauge("TVL_by_Token").record(amount_a, { pairName, pairFullName, name: name_a, symbol: poolInfo.symbol_a, type: poolInfo.type_a })
        ctx.meter.Gauge("TVL_by_Token").record(amount_b, { pairName, pairFullName, name: name_b, symbol: poolInfo.symbol_b, type: poolInfo.type_b })

        ctx.meter.Counter("TVL_by_Token_Counter").add(amount_a!, { pairName, pairFullName, name: name_a, symbol: poolInfo.symbol_a, type: poolInfo.type_a })
        ctx.meter.Counter("TVL_by_Token_Counter").add(amount_b!, { pairName, pairFullName, name: name_b, symbol: poolInfo.symbol_b, type: poolInfo.type_b })
    }
    catch (e) {
